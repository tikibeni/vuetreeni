...
export default {
  ...
  experience_info: [
    ...
    },
    {
      ...
      during: 'Summerwork during 2019 and 2020',
      description: 'I worked a few shifts as a windsurfing coach during the summer seasons of 2019 and 2020. My tasks included coaching and planning the training sessions. ',
      icon: 'sailing'
    },
    {
      workplace: 'Suomen Taitovoimisteluklubi',
      during: 'January 2019',
      description: 'Worked as an assistant instructor for a gymnastics group. ',
      icon: 'accessibility'
    },
    {
  ...
  skills_info: [
    ...
    },
    {
      ...
      name: 'Python',
      grade: 2,
      description: 'The basics from a course programming project'
    },
    {
      key: 'enSQL',
      name: 'SQL',
